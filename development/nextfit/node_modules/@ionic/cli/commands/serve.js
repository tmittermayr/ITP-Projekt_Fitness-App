...
Try the ${color_1.input('--lab')} option to see multiple platforms at once.`;
    ...
    async preRun(inputs, options, { location }) {
        ...
        if (options['lab']) {
            this.env.log.warn(`The ${color_1.input('--lab')} option has been deprecated and will be removed in an upcoming major release of the Ionic CLI. Please visit ${color_1.strong('https://ionicframework.com/docs/developing/previewing')} for alternatives to Ionic Lab.`);
        }
